...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/generateSignature/**").permitAll()
                .antMatchers("/mail/**").hasAnyAuthority(UserRoleName.USER.name(),UserRoleName.ADMIN.name())
                .antMatchers("/api/files/**").hasAnyAuthority(UserRoleName.USER.name(),UserRoleName.ADMIN.name())
                .antMatchers("/image/**").hasAnyAuthority(UserRoleName.USER.name(),UserRoleName.ADMIN.name())
                .antMatchers("/api/user/**").hasAnyAuthority(UserRoleName.USER.name(),UserRoleName.ADMIN.name())
