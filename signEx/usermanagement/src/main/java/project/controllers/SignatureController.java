...
import project.Esignature.VerifySignatureRequest;
...
//    }
    ...
    public ResponseEntity<Boolean> verifySignature(@RequestBody VerifySignatureRequest request) throws Exception {
